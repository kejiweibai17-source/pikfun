...
export default function App() {
  return (
    <Tooltip
      content={
        <div className="p-6 border border-black w-80">
          ...
          <img
            className="w-full"
            src="https://www.ritualzeroproof.com/cdn/shop/articles/Bitters_4576e29a-9d5f-43ac-95c6-7ea247c8561b_2048x.jpg?v=1655914171"
            alt=""
          />
        </div>
      }
    >
      ...
      >
        <a className=" bg-black text-white px-3 py-1 rounded-full text-xs">
          集氣插口
        </a>
      </a>
    </Tooltip>
